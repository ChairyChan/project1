...
function lookUpProfile(name, property){
    for (let i = 0; i < contacts[i].length; i++){
        if (name == contacts[i].firstName)
        {
            if (property == contacts[i].lastName)
            {
                return contacts[i].lastName;
            }
            else if (property == contacts[i].likes)
            {
                return contacts[i].likes;
            }
            else if (property ==  contacts[i].number)
            {
...
// var property = prompt(`Property to check? `);
...
//     var newstring = "Pokemon " + string;
//     return newstring;
// }
// var Pokemon = ["Bulbasaur","Ivysaur","Venusaur","Charmander","Charmeleon","Charizard","Squirtle","Wartortle","Blastoise","Caterpie",
// "Metapod","Butterfree","Weedle","Kakuna","Beedrill","Pidgey","Pidgeotto","Pidgeot","Rattata"]
// var NewPokemon = [];
// NewPokemon = Pokemon.map(addPokemon);
// console.log(NewPokemon);



// function sixChar(string){
//     if(string.length > 6)
//     {
//         return false;
//     }
...
// var Pokemon = ["Bulbasaur","Ivysaur","Venusaur","Charmander","Charmeleon","Charizard","Squirtle","Wartortle","Blastoise","Caterpie",
// "Metapod","Butterfree","Weedle","Kakuna","Beedrill","Pidgey","Pidgeotto","Pidgeot","Rattata"];
// var NewPokemon = Pokemon.filter(sixChar);
// console.log(NewPokemon);
...
// var Pokemon = ["Bulbasaur","Ivysaur","Venusaur","Charmander","Charmeleon","Charizard","Squirtle","Wartortle","Blastoise","Caterpie",
// "Metapod","Butterfree","Weedle","Kakuna","Beedrill","Pidgey","Pidgeotto","Pidgeot","Rattata"]
// var NewPokemon = Pokemon.map(addPokemon);
// console.log(NewPokemon);

// var Pokemon = ["Bulbasaur","Ivysaur","Venusaur","Charmander","Charmeleon","Charizard","Squirtle","Wartortle","Blastoise","Caterpie",
// "Metapod","Butterfree","Weedle","Kakuna","Beedrill","Pidgey","Pidgeotto","Pidgeot","Rattata"];
// var a = Pokemon.map(function (value){
//     var sum = 0;
...
// var Pokemon = ["Bulbasaur","Ivysaur","Venusaur","Charmander","Charmeleon","Charizard","Squirtle","Wartortle","Blastoise","Caterpie",
// "Metapod","Butterfree","Weedle","Kakuna","Beedrill","Pidgey","Pidgeotto","Pidgeot","Rattata"];
// var a = Pokemon.filter(function (value){
//     var sum = 0;
//     for (let i = 0; i < value.length; i++)
//     {
//         sum += value.charCodeAt(i);
